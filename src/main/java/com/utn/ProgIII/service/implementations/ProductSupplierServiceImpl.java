...
public class ProductSupplierServiceImpl implements ProductSupplierService {
    ...
    @Override
    public List<SupplierProductListDTO> listSuppliersByProduct(String productName) {
        ...
        List<SupplierProductListDTO> listDTOS = new ArrayList<>();
        ...
        for (Product product : products){
            ...
            if (authService.hasRole("ROLE_MANAGER")) {
                ...
                BigDecimal dolar = miscService.searchDollarPrice().venta();
                supplierList = productSupplierRepository.listPricesByProductManager(product.getIdProduct(), dolar);

            } else if (authService.hasRole("ROLE_EMPLOYEE")) {
                supplierList = productSupplierRepository.listPricesByProductEmployee(product.getIdProduct());
            }

            SupplierProductListDTO supplierProdcutDto = new SupplierProductListDTO(
                    product.getIdProduct(),
                    product.getName(),
                    supplierList
            );
            listDTOS.add(supplierProdcutDto);
        }
